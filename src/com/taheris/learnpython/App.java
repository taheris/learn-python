package com.taheris.learnpython;

import javafx.application.Application;
import javafx.stage.Stage;
import javafx.stage.StageStyle;
import com.taheris.learnpython.game.Game;
import com.taheris.learnpython.gui.Scenes;
import com.taheris.learnpython.python.Python;
...
public class App extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        setScene("/com/taheris/learnpython/gui/Home.fxml");
        stage.show();
    }
}
